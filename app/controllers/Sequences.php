...
class Sequences extends Controller
{
    ...
    public function create_seq(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->create_seq__icontroller(...$args);
        }
        return $this->create_seq__ntcs(...$args);
    }

    private function create_seq__icontroller(){
    ...
    private function create_seq__ntcs(){
    ...
    public function delete_seq(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->delete_seq__icontroller(...$args);
        }
        return $this->delete_seq__ntcs(...$args);
    }

    private function delete_seq__icontroller(){
    ...
    private function delete_seq__ntcs(){
    ...
    public function edit_seq(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->edit_seq__icontroller(...$args);
        }
        return $this->edit_seq__ntcs(...$args);
    }

    private function edit_seq__icontroller(){
    ...
    private function edit_seq__ntcs(){
    ...
    public function check_seq_enable(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->check_seq_enable__icontroller(...$args);
        }
        return $this->check_seq_enable__ntcs(...$args);
    }

    private function check_seq_enable__icontroller(){
    ...
    private function check_seq_enable__ntcs(){
    ...
    public function copy_seq_data(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->copy_seq_data__icontroller(...$args);
        }
        return $this->copy_seq_data__ntcs(...$args);
    }

    private function copy_seq_data__icontroller(){
    ...
    private function copy_seq_data__ntcs(){
    ...
    public function adjustment_order(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->adjustment_order__icontroller(...$args);
        }
        return $this->adjustment_order__ntcs(...$args);
    }

    private function adjustment_order__icontroller(){
    ...
    private function adjustment_order__ntcs(){
