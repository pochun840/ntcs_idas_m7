...
class Settings extends Controller
{
    ...
    private function normalizeUploadedLinServiceAccount(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->normalizeUploadedLinServiceAccount__icontroller(...$args);
        }
        return $this->normalizeUploadedLinServiceAccount__ntcs(...$args);
    }

    private function normalizeUploadedLinServiceAccount__icontroller(PDO $db): array
    {
    ...
    private function normalizeUploadedLinServiceAccount__ntcs(PDO $db): array
    {
        return SystemConfigImportService::normalizeServiceAccount($db);
        /* Legacy implementation retained below for branch compatibility. */
        $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    private function index__icontroller(){
        header('Cache-Control: no-store, no-cache, must-revalidate, max-age=0');
        header('Pragma: no-cache');
        header('Expires: 0');
    ...
    {
        if (idas_is_icontroller()) {
            return $this->edit_password__icontroller(...$args);
        }
        return $this->edit_password__ntcs(...$args);
    }

    private function edit_password__icontroller(){
    ...
    private function edit_password__ntcs(){
    ...
    public function control_setting(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->control_setting__icontroller(...$args);
        }
        return $this->control_setting__ntcs(...$args);
    }

    private function control_setting__icontroller() {
    ...
    private function control_setting__ntcs() {
    ...
    public function FirmwareUpdate(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->FirmwareUpdate__icontroller(...$args);
        }
        return $this->FirmwareUpdate__ntcs(...$args);
    }

    private function FirmwareUpdate__icontroller(){
    ...
    private function FirmwareUpdate__ntcs(){
    ...
    public function delete_files(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->delete_files__icontroller(...$args);
        }
        return $this->delete_files__ntcs(...$args);
    }

    private function delete_files__icontroller(){
    ...
    private function delete_files__ntcs(){
    ...
    public function Sync_check_db(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->Sync_check_db__icontroller(...$args);
        }
        return $this->Sync_check_db__ntcs(...$args);
    }

    private function Sync_check_db__icontroller(){
    ...
    private function Sync_check_db__ntcs(){
    ...
    public function Sync_check_db_load(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->Sync_check_db_load__icontroller(...$args);
        }
        return $this->Sync_check_db_load__ntcs(...$args);
    }

    private function Sync_check_db_load__icontroller() {
        $file = $this->MiscellaneousModel->lang_load();
        if (!empty($file)) include $file;
    ...
    private function Sync_check_db_load__ntcs() {
        header('Content-Type: application/json; charset=utf-8');
    ...
    private function notifyModbus(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->notifyModbus__icontroller(...$args);
        }
        return $this->notifyModbus__ntcs(...$args);
    }

    private function notifyModbus__icontroller($modbus, $data, $tag = ""){
    ...
    private function notifyModbus__ntcs($modbus = null, $data = [], $tag = ""){
    ...
    public function GetBarcodes(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->GetBarcodes__icontroller(...$args);
        }
        return $this->GetBarcodes__ntcs(...$args);
    }

    private function GetBarcodes__icontroller(){
    ...
    private function GetBarcodes__ntcs(){

        $barcodes = $this->SettingModel->GetAllBarcodes();
        return $barcodes;
    }

    public function show_Barcodes(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->show_Barcodes__icontroller(...$args);
        }
        return $this->show_Barcodes__ntcs(...$args);
    }

    private function show_Barcodes__icontroller(){
    ...
    private function show_Barcodes__ntcs(){
    ...
    public function Update_Barcode(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->Update_Barcode__icontroller(...$args);
        }
        return $this->Update_Barcode__ntcs(...$args);
    }

    private function Update_Barcode__icontroller(){
    ...
    private function Update_Barcode__ntcs(){
    ...
    public function delete_barcodes(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->delete_barcodes__icontroller(...$args);
        }
        return $this->delete_barcodes__ntcs(...$args);
    }

    private function delete_barcodes__icontroller(){
    ...
    private function delete_barcodes__ntcs(){
    ...
    public function idas_database_maintenance(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->idas_database_maintenance__icontroller(...$args);
        }
        return $this->idas_database_maintenance__ntcs(...$args);
    }

    private function idas_database_maintenance__icontroller() {
        header('Content-Type: application/json; charset=utf-8');
    ...
    private function idas_database_maintenance__ntcs(){
        header('Content-Type: application/json; charset=utf-8');
        $action = strtolower(trim((string)($_POST['action'] ?? 'status')));
    ...
    public function check_idas_pack_version(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->check_idas_pack_version__icontroller(...$args);
        }
        return $this->check_idas_pack_version__ntcs(...$args);
    }

    private function check_idas_pack_version__icontroller() {
        header('Content-Type: application/json; charset=utf-8');
    ...
    private function check_idas_pack_version__ntcs(){
    ...
    public function iDas_Update(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->iDas_Update__icontroller(...$args);
        }
        return $this->iDas_Update__ntcs(...$args);
    }

    private function iDas_Update__icontroller($debug = false) {
    ...
    private function iDas_Update__ntcs($debug = false) {
    ...
    private function readIdasPackInfoFromZip(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->readIdasPackInfoFromZip__icontroller(...$args);
        }
        return $this->readIdasPackInfoFromZip__ntcs(...$args);
    }

    private function readIdasPackInfoFromZip__icontroller(string $packPath): array {
        $zip = new ZipArchive();
    ...
    private function readIdasPackInfoFromZip__ntcs(string $zipPath): array{
    ...
    private function normalizeIdasVersionDisplay(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->normalizeIdasVersionDisplay__icontroller(...$args);
        }
        return $this->normalizeIdasVersionDisplay__ntcs(...$args);
    }

    private function normalizeIdasVersionDisplay__icontroller(string $version): string {
    ...
    private function normalizeIdasVersionDisplay__ntcs($version): string{
    ...
    private function normalizeIdasVersionBase(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->normalizeIdasVersionBase__icontroller(...$args);
        }
        return $this->normalizeIdasVersionBase__ntcs(...$args);
    }

    private function normalizeIdasVersionBase__icontroller(string $version): string {
        $version = trim($version);
        if ($version === '') {
            return '0.0.0';
        }
    ...
    private function normalizeIdasVersionBase__ntcs($version): string{
    ...
    private function acquireIdasUpdateLock(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->acquireIdasUpdateLock__icontroller(...$args);
        }
        return $this->acquireIdasUpdateLock__ntcs(...$args);
    }

    private function acquireIdasUpdateLock__icontroller() {
    ...
    private function acquireIdasUpdateLock__ntcs()
    {
        $lockDir = (PHP_OS_FAMILY === 'Linux') ? IDAS_PATH_DATABASE_ROOT : sys_get_temp_dir();
    ...
    private function t(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->t__icontroller(...$args);
        }
        return $this->t__ntcs(...$args);
    }

    private function t__icontroller(string $key, array $vars = []): string {
        static $DICT = [
            'ERR_NO_FILE'       => [
...
请确认 Controller 与 iDAS 的数据库版本是否兼容，或改用对应版本的更新包后再重新执行。",
    ...
    private function t__ntcs(string $key, array $vars = []): string {
        static $DICT = [
            'ERR_NO_FILE'       => [
                'en-us' => 'No file uploaded.',
                'zh-tw' => '未上傳檔案。',
    ...
    private function sendResponse(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->sendResponse__icontroller(...$args);
        }
        return $this->sendResponse__ntcs(...$args);
    }

    private function sendResponse__icontroller($type, $msg) {
        while (ob_get_level()) {
            @ob_end_clean();
        }
        header('Content-Type: application/json; charset=utf-8');
    ...
    private function sendResponse__ntcs($type, $msg, array $extra = []) {
    ...
    private function copyDirectory(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->copyDirectory__icontroller(...$args);
        }
        return $this->copyDirectory__ntcs(...$args);
    }

    private function copyDirectory__icontroller($source, $destination) {
        if (!is_dir($source)) {
    ...
    private function copyDirectory__ntcs($source, $destination) {
        if (!is_dir($source)) {
    ...
    private function deleteDirectory(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->deleteDirectory__icontroller(...$args);
        }
        return $this->deleteDirectory__ntcs(...$args);
    }

    private function deleteDirectory__icontroller($dir) {
    ...
    private function deleteDirectory__ntcs($dir) {
        if (!is_dir($dir)) return;
    ...
    public function Import_Config(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->Import_Config__icontroller(...$args);
        }
        return $this->Import_Config__ntcs(...$args);
    }

    private function Import_Config__icontroller(){
    ...
    private function Import_Config__ntcs(){
    ...
    public function setting_logout(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->setting_logout__icontroller(...$args);
        }
        return $this->setting_logout__ntcs(...$args);
    }

    private function setting_logout__icontroller() {
    ...
    private function setting_logout__ntcs() {
    ...
    public function get_controller_login(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->get_controller_login__icontroller(...$args);
        }
        return $this->get_controller_login__ntcs(...$args);
    }

    private function get_controller_login__icontroller() {
    ...
    private function get_controller_login__ntcs() {
    ...
    private function syncFilesToController(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->syncFilesToController__icontroller(...$args);
        }
        return $this->syncFilesToController__ntcs(...$args);
    }

    private function syncFilesToController__icontroller(ModbusMaster $modbus): void {
    ...
    private function syncFilesToController__ntcs($modbus = null): void {
    ...
    public function account_user_list(): void
    {
        try {
            ...
            // service 帳號需要顯示在 Account 清單，但儲存/刪除會被保護。
            $rows = $db->query("
    ...
    public function account_user_export(): void
    {
        try {
            ...
            // Export all accounts, including the built-in service account.
            $rows = $db->query("
                SELECT sn, name, passwd, law
                FROM `user`
                ORDER BY sn ASC
    ...
    public function account_user_import(): void
    {
        try {
            ...
            $protectedUsers = ['service', 'guest', 'admin'];
            ...
            if ($importMode === 'overwrite') {
                ...
                $db->exec("DELETE FROM `user` WHERE LOWER(name) NOT IN ('service', 'guest', 'admin')");
            }
    ...
    public function account_user_update(): void
    {
        try {
            ...
            // service can be opened for viewing, but saving is blocked.
            if ($this->accountUserIsProtectedName($oldName)) {
                if ($oldNameLower === 'service') {
