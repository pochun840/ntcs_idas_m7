...
class Step extends Controller
{
    ...
    public function create_step(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->create_step__icontroller(...$args);
        }
        return $this->create_step__ntcs(...$args);
    }

    private function create_step__icontroller() {
    ...
    private function create_step__ntcs() {
        $file = $this->MiscellaneousModel->lang_load();
        if (!empty($file)) include $file;
    ...
    public function edit_step(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->edit_step__icontroller(...$args);
        }
        return $this->edit_step__ntcs(...$args);
    }

    private function edit_step__icontroller(){
    ...
    private function edit_step__ntcs(){
    ...
    public function delete_step(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->delete_step__icontroller(...$args);
        }
        return $this->delete_step__ntcs(...$args);
    }

    private function delete_step__icontroller(){
    ...
    private function delete_step__ntcs(){
    ...
    public function copy_step(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->copy_step__icontroller(...$args);
        }
        return $this->copy_step__ntcs(...$args);
    }

    private function copy_step__icontroller(){
    ...
    private function copy_step__ntcs(){
