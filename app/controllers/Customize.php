...
class Customize extends Controller
{
    ...
    public function save_positions(...$args)
    {
        if (idas_is_icontroller()) {
            return $this->save_positions__icontroller(...$args);
        }
        return $this->save_positions__ntcs(...$args);
    }

    private function save_positions__icontroller(){
    ...
    private function save_positions__ntcs(){
