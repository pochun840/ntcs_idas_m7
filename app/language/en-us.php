...
$text['data_time'] = 'Data Time';
$text['device_type'] = 'Device Type';
$text['device_id'] = 'Controller ID';
$text['device_sn'] = 'Controller Serial No.';
$text['tool_type'] = 'Tool Model';
$text['tool_sn'] = 'Tool Serial No.';
$text['tool_status'] = 'Tool Status';
$text['job_id'] = 'Job ID';
$text['job_name'] = 'Job Name';
...
$text['fasten_time'] = 'Total Fasten Time';
$text['final_fasten_torque'] = 'Final Torque';
$text['final_fasten_angle'] = 'Final Angle';
$text['total_fasten_angle'] = 'Total Angle';
$text['count_type'] = 'Count Mode';
$text['last_screw_count'] = 'Last Screw Count';
$text['total_screw_count'] = 'Total Screw Count';
$text['fasten_status'] = 'Fasten Result';
$text['error_message'] = 'Error Message';
$text['fasten_direction'] = 'Fasten Direction';
$text['rpm'] = 'RPM';
$text['hi_torque'] = 'High Torque Limit';
$text['lo_torque'] = 'Low Torque Limit';
$text['hi_angle'] = 'High Angle Limit';
$text['lo_angle'] = 'Low Angle Limit';
...
$text['final_tool_current'] = 'Tool Current';
$text['barcode'] = 'Barcode';
