        ...
        <div class="row t2 border-bottom">
          <div class="col t2">
            <form id="edit_password" method="get" style="margin: 3px 0px;">
              <input type="password" id="new_password" size="18" placeholder="<?php echo $text['system_new_password'];?>" maxlength="10" required class="t3 w3-submit w3-border w3-round">
              ...
              <input type="button" value="<?php echo $text['save'];?>"  onclick="edit_password()"  class="all-btn w3-submit w3-border w3-round-large" >
            </form>
          </div>        
        </div>     
        ...
        <div class="row t2">
          <div class="col t2">
            <form>
              ...
              <input type="button" value="<?php echo $text['save'];?>" class="all-btn w3-submit w3-border w3-round-large" onclick="time_save()">
            </form>
          </div>        
        </div> 
...
<style>
  ...
  /* nút luôn nằm bên phải */
  .setting_force-overflow .all-btn
  {
      margin-left: auto;
  }
