<div id="Barcode_Setting" class="divMode" style="display: none; overflow-x: hidden;"  >
        ...
        <div class="barcode-container">
            <div class="setting_scrollbar" id="style-setting">
                <div class="setting_force-overflow">
                    <table id="job_table" class="table-barcode table">
                        <thead id="header-table" style="font-size: 3vmin;">
                        ...
                        <tbody style="font-size: 2.5vmin;text-align: center;" id='total_barcodes'>
    ...
    <div class="barcode-mode" style="display: none; overflow-x: hidden;">                       
        <div class="row t2">
